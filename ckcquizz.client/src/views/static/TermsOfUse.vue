<template>
    <a-layout>
        <a-layout-content style="padding: 24px; background: #fff; min-height: 280px;">
            <a-typography>
                <a-typography-title>Điều khoản sử dụng</a-typography-title>
                <a-typography-paragraph>
                    Chào mừng bạn đến với CKCQuiz! Bằng cách truy cập hoặc sử dụng dịch vụ của chúng tôi, bạn đồng ý tuân thủ các điều khoản và điều kiện sau đây.
                </a-typography-paragraph>
                <a-typography-paragraph>
                    1. Chấp nhận Điều khoản: Việc bạn sử dụng dịch vụ của chúng tôi đồng nghĩa với việc bạn đã đọc, hiểu và đồng ý với tất cả các điều khoản và điều kiện được nêu trong tài liệu này. Nếu bạn không đồng ý với bất kỳ điều khoản nào, vui lòng không sử dụng dịch vụ.
                </a-typography-paragraph>
                <a-typography-paragraph>
                    2. Thay đổi Điều khoản: Chúng tôi có quyền sửa đổi các điều khoản này bất cứ lúc nào. Mọi thay đổi sẽ có hiệu lực ngay khi được đăng tải trên trang web. Việc bạn tiếp tục sử dụng dịch vụ sau khi các thay đổi được đăng tải sẽ được coi là bạn đã chấp nhận các điều khoản đã sửa đổi.
                </a-typography-paragraph>
                <a-typography-paragraph>
