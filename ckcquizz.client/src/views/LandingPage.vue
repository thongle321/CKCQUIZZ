                                ...
                                <div class="col-md-6 py-4 d-flex align-items-center" 
                                    ...
                                    <div class="text-center text-md-start">
                                        ...
                                        <a class="btn btn-alt-primary py-2 px-3 m-1" href="auth/signin" target="_blank">
                                            <font-awesome-icon icon="fa fa-arrow-right opacity-50 me-1"></font-awesome-icon> Tham gia ngay
                                        </a>
                                        <a class="btn btn-alt-secondary py-2 px-3 m-1 btn--scroll-to">
                                            <font-awesome-icon icon="fa fa-arrow-down opacity-50 me-1"></font-awesome-icon> Tìm hiểu thêm
                                        </a>
                                    </div>
                                </div>
                            </div>
