...
namespace CKCQUIZZ.Server.Migrations
{
    ...
    [Migration("20250608045026_Sửa lại các bảng phân quyền")]
    partial class Sửalạicácbảngphânquyền
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CKCQUIZZ.Server.Models.ChiTietQuyen", b =>
                {
                    ...
                    b.HasOne("CKCQUIZZ.Server.Models.ApplicationRole", "ApplicationRole")
                        .WithMany("ChiTietQuyens")
