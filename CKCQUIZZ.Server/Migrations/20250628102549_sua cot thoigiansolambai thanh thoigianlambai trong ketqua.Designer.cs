...
namespace CKCQUIZZ.Server.Migrations
{
    ...
    [Migration("20250628102549_sua cot thoigiansolambai thanh thoigianlambai trong ketqua")]
    partial class suacotthoigiansolambaithanhthoigianlambaitrongketqua
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CKCQUIZZ.Server.Models.ChiTietDeThiSinhVien", b =>
                {
                    b.Property<int>("MachitietDTSV")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("machitietDTSV");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MachitietDTSV"));
                    ...
                    b.ToTable("ChiTietDeThiSinhVien", (string)null);
                });
            ...
            modelBuilder.Entity("CKCQUIZZ.Server.Models.ChiTietTraLoiSinhVien", b =>
                {
                    ...
                    b.Property<string>("Dapantuluansv")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CKCQUIZZ.Server.Models.ChiTietDeThiSinhVien", b =>
                {
                    b.HasOne("CKCQUIZZ.Server.Models.NguoiDung", "IdNavigation")
                        .WithMany()
                        .HasForeignKey("Id")
