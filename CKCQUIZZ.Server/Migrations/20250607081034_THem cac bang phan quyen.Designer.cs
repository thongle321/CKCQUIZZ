...
namespace CKCQUIZZ.Server.Migrations
{
    ...
    [Migration("20250607081034_THem cac bang phan quyen")]
    partial class THemcacbangphanquyen
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CKCQUIZZ.Server.Models.HanhDong", b =>
                {
                    ...
                    b.HasKey("Mahanhdong")
                        .HasName("PK__HanhDong");

                    b.ToTable("HanhDong", (string)null);
                });
            ...
            modelBuilder.Entity("CKCQUIZZ.Server.Models.PhuongThuc", b =>
                {
                    ...
                    b.HasKey("Maphuongthuc")
                        .HasName("PK__PhuongThuc");

                    b.ToTable("PhuongThuc", (string)null);
                });

            modelBuilder.Entity("CKCQUIZZ.Server.Models.PhuongThucHanhDong", b =>
                {
                    b.Property<string>("Mahanhdong")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)")
                    ...
                    b.HasKey("Mahanhdong", "Maphuongthuc");

                    b.ToTable("PhuongThucHanhDong", (string)null);
                });

            modelBuilder.Entity("CKCQUIZZ.Server.Models.Quyen", b =>
                {
                    ...
                    b.HasKey("Maquyen", "Maphuongthuc", "Mahanhdong");
            ...
            modelBuilder.Entity("CKCQUIZZ.Server.Models.DanhSachLop", b =>
                {
                    b.HasOne("CKCQUIZZ.Server.Models.Lop", "LopNavigation")
                    ...
                    b.HasOne("CKCQUIZZ.Server.Models.MonHoc", "MonHocNavigation")
                        .WithMany("DanhSachLops")
                        .HasForeignKey("Mamonhoc")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.Navigation("LopNavigation");

                    b.Navigation("MonHocNavigation");
                });
