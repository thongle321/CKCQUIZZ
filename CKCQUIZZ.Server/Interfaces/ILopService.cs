...
namespace CKCQUIZZ.Server.Interfaces
{
    ...
    {
        Task<List<Lop>> GetAllAsync(string userId, bool? hienthi, string userRole, string? searchQuery);
        ...
        Task<ImportStudentDTO> ImportStudentsFromExcelAsync(Stream excelFileStream);
    }
